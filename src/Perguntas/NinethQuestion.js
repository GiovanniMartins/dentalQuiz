...
const PerguntaNove = ({navigation}) => {
    ...
    return(
        ...
        <View  style={styles.background}>
            <Text style={styles.backgroundQuestion}>Nona pergunta</Text>
            ...
            <Modal  
                ...
                <View>
                    <View style={styles.modalView}>
                        ...
                        <Text style={styles.modalText}>Errado! Tem que escovar sempre a língua pois ela acumula sujeira</Text>
